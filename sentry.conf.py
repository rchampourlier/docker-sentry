...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("DB_ENV_DB", "sentry"),
        'USER': os.environ.get("DB_ENV_USER", "admin"),
        'PASSWORD': os.environ.get("DB_ENV_PASS", "password"),
...
SENTRY_URL_PREFIX = os.environ.get("URL_PREFIX", 'http://127.0.0.1:9000')  # No trailing slash!
